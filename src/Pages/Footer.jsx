  ...
  return (
    <footer className="bg-gray-800 text-white py-6 mt-12 flex ">
        <div className="container mx-auto font-sans-serif font-thin text-2xl flex ">
            ...
            <ul className="ml-auto text-sm flex gap-4">
                <li><a href="#contactpage" className="hover:underline mr-4">Contact Me</a></li>
            </ul>
             <a href="#" className="ml-10 text-sm hover:underline">Back to Top</a>        </div>
